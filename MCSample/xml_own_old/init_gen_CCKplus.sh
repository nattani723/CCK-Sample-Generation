...
echo "outputs.out1.fileName: \"prodgenie_numi_nu_filtered_CCKplus_uboone_%tc_gen.root\"" >> local_gen.fcl
...
echo "physics.producers.generator.TopVolume: \"volCryostat\"" >> v local_gen.fcl
#echo "physics.producers.generator.TopVolume: \"volTPCActive\"" >> v local_gen.fcl
